...
import { getProfile, getUserProfile, getStatus, 
  updateStatus, uploadPhoto } from './../../redux/ProfileReducer'
...
export default compose(
  connect(mapStateToProps, { getProfile, getUserProfile, getStatus, updateStatus, uploadPhoto }),
  withRouter,
  withAuthRerander
)(ProfileContainer)